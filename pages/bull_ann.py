...
class BullAnn(ft.Tab):
    def __init__(self, cp: object):
        super(BullAnn, self).__init__(
            tab_content=ft.Row(
                controls=[
                    ft.Icon(ft.icons.RULE_FOLDER, size=20),
                    ft.Text("Annuels".upper(), font_family="Poppins Medium", size=12)
                ]
            )
        )
        self.cp = cp  # Conteneur parent
        self.classe = ft.Dropdown(**drop_style, prefix_icon="school_outlined", label="classe", width=150)
        self.sequence = ft.Dropdown(**drop_style, prefix_icon=ft.icons.CALENDAR_MONTH_SHARP, label="Trimestre",
                                    width=150)
        ...
        self.table_seq = ft.DataTable(
            ...
            heading_text_style=ft.TextStyle(size=12, font_family="Poppins Medium", color="grey"),
        )
                ...
                ft.Container(
                    ...
                    content=ft.Column(
                        ...
                        controls=[
                            ...
                            ft.Row(
                                controls=[
                                    ft.Text("Bulletins trimestre", size=14, font_family="Poppins Bold"),
                                    ft.Container(
                                        bgcolor="red", border_radius=10, padding=10,
                                        border=ft.border.all(1, "red"),
                                        on_click=self.open_select_window,
                                        content=ft.Row(
                                            [
                                                ft.Text("Imprimler classe", size=12,
                                                        color="white",
